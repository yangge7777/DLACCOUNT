...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div id="main">
            ...
            <form action="<%=request.getContextPath()%>/fee/cost_update.do" method="post" class="main_form"  >
                <div class="text_info clearfix"><span >资费ID：</span></div>
                <div class="input_info"><input type="text" class="readonly"  name="cost_id" value="${cost.cost_id}" /></div>
